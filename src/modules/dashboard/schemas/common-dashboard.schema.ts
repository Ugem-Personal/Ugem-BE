...
export const createLimitSchema = (defaultValue: number, maximum: number) =>
...
export const createYearQuerySchema = () =>
  z.object({
    query: z.object({
      year: yearSchema,
    }),
...
export const createLimitQuerySchema = (defaultValue: number, maximum: number) =>
  z.object({
    query: z.object({
...
export const createDateRangeQuerySchema = () =>
  z.object({
    query: z
      .object({
