...
const normalizeCreateCampaignBody = <
  T extends Partial<z.infer<typeof campaignCompatibilityBodySchema>>,
>(
  body: T,
) => ({
  ...body,
...
const normalizeUpdateCampaignBody = <
  T extends Partial<z.infer<typeof campaignCompatibilityBodySchema>>,
>(
  body: T,
) => ({
...
const validateNormalizedCampaign = (
  body: ReturnType<typeof normalizeCreateCampaignBody>,
