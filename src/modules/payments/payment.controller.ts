...
export const requestCashConfirmation = asyncHandler(
  async (req: Request, res: Response) => {
    const bill = await paymentService.requestCashConfirmation(
      getCustomerId(req),
...
export const getCustomerBills = asyncHandler(
  async (req: Request, res: Response) => {
    const bills = await paymentService.getCustomerBills(
      getCustomerId(req),
...
export const processSepayWebhook = asyncHandler(
  async (req: Request, res: Response) => {
