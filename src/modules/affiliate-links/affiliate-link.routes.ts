...
} from "./affiliate-link.controller.js";

import {
  affiliateCodeSchema,
  affiliateEarningsSchema,
  createAffiliateLinkSchema,
  updateAffiliateLinkStatusSchema,
} from "./affiliate-link.schema.js";
...
affiliateLinkRouter.get(
  "/earnings",
  validate(affiliateEarningsSchema),
  getReviewerEarnings,
);
...
affiliateLinkRouter.patch(
  "/:id/status",
  validate(updateAffiliateLinkStatusSchema),
  updateAffiliateLinkStatus,
);
