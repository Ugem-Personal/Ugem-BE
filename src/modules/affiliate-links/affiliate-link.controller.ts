...
export const getMyAffiliateLinks = asyncHandler(
  async (req: Request, res: Response) => {
    const links = await affiliateLinkService.getMyAffiliateLinks(
      getReviewerId(req),
    );
...
export const updateAffiliateLinkStatus = asyncHandler(
  async (req: Request, res: Response) => {
    const link = await affiliateLinkService.updateAffiliateLinkStatus(
      getReviewerId(req),
      getParam(req, "id"),
      req.body,
    );
...
export const trackAffiliateLink = asyncHandler(
  async (req: Request, res: Response) => {
    const result = await affiliateLinkService.trackAffiliateLink(
      getParam(req, "code"),
      {
...
export const getReviewerEarnings = asyncHandler(
  async (req: Request, res: Response) => {
    const result = await affiliateLinkService.getReviewerEarnings(
      getReviewerId(req),
      {
