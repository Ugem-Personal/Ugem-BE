...
import {
  GEM_POINT_POLICY,
  type GemPointAction,
} from "../../common/constants/gem-point-policy.js";
...
const getTransactionType = (action: GemPointAction) =>
  GEM_POINT_TRANSACTION_TYPE[action];

export const awardGemPoints = async (
  transaction: Prisma.TransactionClient,
  params: {
    customerId: string;
    action: GemPointAction;
    referenceId: string;
    reason?: string;
  },
) => {
