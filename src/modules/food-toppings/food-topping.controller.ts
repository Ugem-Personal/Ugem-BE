...
export const getToppingsByFood = asyncHandler(
  async (req: Request, res: Response) => {
    const toppings = await toppingService.getToppingsByFood(
      getParam(req, "foodId"),
    );
...
export const getMyFoodToppings = asyncHandler(
  async (req: Request, res: Response) => {
...
export const createTopping = asyncHandler(
  async (req: Request, res: Response) => {
...
export const updateTopping = asyncHandler(
  async (req: Request, res: Response) => {
...
export const deleteTopping = asyncHandler(
  async (req: Request, res: Response) => {
...
export const updateToppingByBody = asyncHandler(
  async (req: Request, res: Response) => {
