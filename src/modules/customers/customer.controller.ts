...
export const getCustomerPreferences = asyncHandler(
  async (req: Request, res: Response) => {
...
export const updateCustomerPreferences = asyncHandler(
  async (req: Request, res: Response) => {
    const customerId = getCustomerId(req);

    const preferences = await customerService.updateCustomerPreferences(
      customerId,
      req.body,
    );
