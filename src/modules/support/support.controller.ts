...
export const getMerchantTickets = asyncHandler(
  async (req: Request, res: Response) => {
    ...
    return sendSuccess(res, {
      message: "Lấy yêu cầu hỗ trợ thành công",
      data: tickets,
    });
  },
);

export const getMerchantTicket = asyncHandler(
  async (req: Request, res: Response) => {
    const ticket = await supportService.getMerchantTicket(
      getMerchantId(req),
      getId(req),
    );
    return sendSuccess(res, {
...
export const addMerchantMessage = asyncHandler(
  async (req: Request, res: Response) => {
...
export const updateMerchantStatus = asyncHandler(
  async (req: Request, res: Response) => {
...
export const getStaffTickets = asyncHandler(
  async (req: Request, res: Response) => {
...
export const getStaffTicket = asyncHandler(
  async (req: Request, res: Response) => {
    const ticket = await supportService.getStaffTicket(getId(req));
    return sendSuccess(res, {
      message: "Lấy chi tiết hỗ trợ thành công",
      data: ticket,
    });
  },
);

export const addStaffMessage = asyncHandler(
  async (req: Request, res: Response) => {
    ...
    return sendSuccess(res, {
      message: "Đã gửi phản hồi cho Merchant",
      data: ticket,
    });
  },
);
...
export const updateStaffStatus = asyncHandler(
  async (req: Request, res: Response) => {
    const ticket = await supportService.updateStaffStatus(
      getUserId(req),
      getId(req),
      req.body,
    );
