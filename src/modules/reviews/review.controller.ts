...
export const getMerchantReviews = asyncHandler(
  async (req: Request, res: Response) => {
    const result = await reviewService.getMerchantReviews(
...
export const getMerchantReviewsByQuery = asyncHandler(
  async (req: Request, res: Response) => {
    const result = await reviewService.getMerchantReviews(
      String(req.query.merchantId),
      {
        pageIndex: Number(req.query.pageIndex ?? 1),
...
export const getReviewDetailsByQuery = asyncHandler(
  async (req: Request, res: Response) => {
    const details = await reviewService.getReviewDetails(
      String(req.query.reviewId),
    );
...
export const updateReviewByBody = asyncHandler(
  async (req: Request, res: Response) => {
