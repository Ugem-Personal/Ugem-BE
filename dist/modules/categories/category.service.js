...
import { MAIN_DISH_TYPES, PRICE_RANGES, RESTAURANT_TYPES, } from "../../common/constants/discovery-options.js";
...
export const updateCategory = async (categoryId, input) => {
    ...
    const parentId = input.parentId !== undefined ? input.parentId || null : undefined;
