...
authRouter.post("/register", registrationRateLimiter, validate(registerSchema), register);
authRouter.post("/login", authRateLimiter, validate(loginSchema), login);
authRouter.post("/google-login", authRateLimiter, validate(googleLoginSchema), googleLogin);
