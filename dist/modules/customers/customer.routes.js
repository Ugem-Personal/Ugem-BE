...
import { getCustomerPreferences, getMyRedeemedVouchers, getReviewerProfile, redeemVoucher, searchCustomersByEmail, searchCustomersByPhoneNumber, updateCustomerPreferences, } from "./customer.controller.js";
import { redeemVoucherSchema, searchCustomersByEmailSchema, searchCustomersByPhoneNumberSchema, updateCustomerPreferencesSchema, } from "./customer.schema.js";
...
customerRouter.post("/redeem-voucher", authorizeRoles("Customer", "Reviewer"), validate(redeemVoucherSchema), redeemVoucher);
customerRouter.get("/my-vouchers", authorizeRoles("Customer", "Reviewer"), getMyRedeemedVouchers);
