...
const getMerchantIdFromBody = (req) => {
...
export const addWishlist = asyncHandler(async (req, res) => {
    const wishlist = await wishlistService.addWishlist(getCustomerId(req), getMerchantIdFromBody(req));
    return sendSuccess(res, {
        statusCode: 201,
...
export const addWishlistByParam = asyncHandler(async (req, res) => {
    const wishlist = await wishlistService.addWishlist(getCustomerId(req), getParam(req, "merchantId"));
    return sendSuccess(res, {
        statusCode: 201,
        message: "Thêm Merchant vào danh sách yêu thích thành công",
        data: wishlist,
...
export const removeWishlist = asyncHandler(async (req, res) => {
    const result = await wishlistService.removeWishlist(getCustomerId(req), getParam(req, "merchantId"));
    return sendSuccess(res, {
...
export const checkWishlist = asyncHandler(async (req, res) => {
    const result = await wishlistService.checkWishlist(getCustomerId(req), getParam(req, "merchantId"));
    return sendSuccess(res, {
