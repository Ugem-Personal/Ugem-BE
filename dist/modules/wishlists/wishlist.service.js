...
export const getMyWishlists = async (customerId) => {
...
export const addWishlist = async (customerId, merchantId) => {
...
export const removeWishlist = async (customerId, merchantId) => {
    const existing = await prisma.wishlist.findUnique({
        where: {
            customerId_merchantId: {
                customerId,
...
export const checkWishlist = async (customerId, merchantId) => {
