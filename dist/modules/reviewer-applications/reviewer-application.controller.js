...
export const createReviewerApplication = asyncHandler(async (req, res) => {
    const application = await reviewerApplicationService.createReviewerApplication(getCustomerId(req), req.body);
...
export const getMyReviewerApplication = asyncHandler(async (req, res) => {
    const application = await reviewerApplicationService.getMyReviewerApplication(getCustomerId(req));
    return sendSuccess(res, {
...
export const updateReviewerApplication = asyncHandler(async (req, res) => {
    const application = await reviewerApplicationService.updateReviewerApplication(getCustomerId(req), req.body);
    return sendSuccess(res, {
